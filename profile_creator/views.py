    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if file_type not in IMAGE_FILE_TYPES:
                return render(request, 'profile_creator/error.html')
            user_pr.save()
...
def list_view(request):
    ...
    return render(request, 'profile_creator/list_view.html', context)

def detail_view(request, id):
    context = {}
    context['data'] = User_Profile.objects.get(id = id)

    return render(request, 'profile_creator/detail_view.html', context)
...
def update_view(request, id):
    ...
    return render(request, 'profile_creator/update_view.html', context)
